...
public class ReservationServiceTest {
    ...
    String dateRoom1Id = LocalDate.now()+"&&1";
    String dateRoom2Id = LocalDate.now()+"&&2";
    Payment payment;
    ...
    public void test_makeReservation() {
        ...
        MakeReservationHomeDto requestDto1 = new MakeReservationHomeDto(dateRoom1, guest1, payment);
        MakeReservationAirbnbDto requestDto2 = new MakeReservationAirbnbDto(dateRoom2, guest2, payment_airbnb);
    ...
    public void test_makeReservation_concurrency() throws InterruptedException {
        ...
        MakeReservationHomeDto requestDto3 = new MakeReservationHomeDto(dateRoom1, guest3, payment3);
        MakeReservationHomeDto requestDto4 = new MakeReservationHomeDto(dateRoom1, guest4, payment4);
